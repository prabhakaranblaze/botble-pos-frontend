...
class Product extends BaseModel
{
    ...
    protected $casts = [
        ...
        'is_featured' => 'bool',
        'is_stampsmart_fulfillment' => 'bool',
    ...
    /**
     * Scope to filter products by fulfillment status
     */
    public function scopeFulfillment($query, $isFulfillment = true)
    {
        return $query->where('is_stampsmart_fulfillment', $isFulfillment);
    }

    /**
     * Check if product is a fulfillment product
     */
    public function isFulfillmentProduct(): bool
    {
        return (bool) $this->is_stampsmart_fulfillment;
    }

...
class ProductTable extends TableAbstract
{
    public function setup(): void
    {
        $this
            ...
            ->addColumns([
                ...
                Column::make('is_available_in_pos')
                    ->title(trans('plugins/ecommerce::ecommerce.pos'))
                    ->width(50),
                StatusColumn::make(),
            ])
    ...
    public function ajax(): JsonResponse
    {
        $data = $this->table
            ...
            ->editColumn('is_available_in_pos', function (Product $item) {
                 return $item->is_available_in_pos == 1 ? 'Yes' : 'No';
            })
    ...
    public function getBulkChanges(): array
    {
        return [
            ...
            'is_available_in_pos' => [
                'title' => trans('plugins/ecommerce::ecommerce.is_pos'),
                'type' => 'select',
                'choices' => [
                    1 => 'Yes',
                    0 => 'No',
    ...
    {    
        ...
        if ($inputKey === 'is_available_in_pos') {
             $updated = Product::query()->where('id', $item->id)->update(['is_available_in_pos' => (int) $inputValue]);
             return $item;
        }
